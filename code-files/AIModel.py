...
model_name = "gemini-1.5-pro"   #use gemini-1.5-flash-latest for faster results and more api requests
...
auth_token = 'twilio_authid'
twilio_client = TwilioClient(account_sid, auth_token)

# Twilio phone numbers
from_phone_number = 'enter_twilio_number'
to_phone_number = 'enter_your_number'
...
process_live_video(
    "enter_your_youtube_video",
    user_content="c2",
    security_level="enter_your_security_level"  #options: low mid high
)
